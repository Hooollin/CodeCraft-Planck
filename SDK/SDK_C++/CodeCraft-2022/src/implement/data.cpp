...
void Data::SetClientNode(std::unordered_map<std::string, ClientNode *> &client_map) {
...
std::unordered_map<std::string,int> &Data::GetDistribution(int &day, std::string &client){
  return distribution_[day][client];
}

void Data::SetDistribution(int &day, std::string &client, std::string &edge, int num) {
  if (num == 0)
...
void Data::SetEdgeNodeOrder(std::vector<std::string> &order){
  edge_order_ = order;
}

void Data::SetClientNodeOrder(std::vector<std::string> &order){
  client_order_ = order;
}
